...
class PatternExtractor:
    ...
    def find_agent_handoff_patterns(self) -> List[Dict[str, Any]]:
        """
    ...
    def find_token_inefficiency_patterns(
        self,
    ...
    def generate_pattern_report(self) -> str:
        ...
        """
        error_patterns = self.find_error_patterns(min_occurrences=2)
        slow_ops = self.find_slow_operations(limit=5)
        success_patterns = self.find_success_patterns(limit=5)
