"""
QuickLogger - Minimal logging for immediate Story 1.2 use
Simple JSONL append-only logging with zero performance impact
"""
...
class QuickLogger:
    ...
    def __init__(self, story_id: str = "1.2"):
        ...
        self.base_path = Path("D:/Logs/MADF")
...
def get_logger(story_id: str = "1.2") -> QuickLogger:
